...
opcodes_table: List[Tuple[int, str, int, int, Dict[str, int]]] = [
    ...
    (
        ...
        {
            'd': 0b0000_0000_1111_1111,  # d (PC-relative displacement * 2)
        }
    ), (
        274, "ldre 0x{d:04x}",
        0b1111_1111_0000_0000,
        ...
        275, "ldrc #0x{d:02x}",
        0b1111_1111_0000_0000,
        0b1000_1010_0000_0000,
        {
            'd': 0b0000_0000_1111_1111,  # d (8-bit immediate)
        }
    ), (
        276, "ldrc r{m:d}",
        0b1111_0000_1111_1111,
        0b0100_0000_0011_0100,
        {
